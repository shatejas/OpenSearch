    ...
    public void testReadOnlyEngine() throws Exception {
        ...
        try (Store store = createStore()) {
            ...
            try (InternalEngine engine = createEngine(config)) {
                ...
                OpenSearchMultiReader dirReader = external.getMultiDirectoryReader();
                OpenSearchMultiReader esReader = OpenSearchMultiReader.getOpenSearchMultiDirectoryReader(dirReader);
